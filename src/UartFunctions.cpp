...
#include "UartFunctions.h"  // VE3OOI Serial Interface Routines (TTY Commands)
...
u_int8_t command_entries;
u_int32_t numbers[MAX_COMMAND_ENTRIES];
u_int8_t ctr;
...
{
  static u_int8_t i, j, k;  // Misc counters used, i is for serial buffer,
